              ...
              <div class="col-sm-5">
                <div class="single-welcome-hero">
                  <div class="welcome-hero-img">
                    <img src="<?php echo URLROOT ?>/public/assets/images/slider/slider1.png" alt="slider image" />
                  </div>
                  <!--/.welcome-hero-txt-->
                </div>
                <!--/.single-welcome-hero-->
          ...
          <div class="welcome-hero-content">
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="single-welcome-hero">
                  <div class="welcome-hero-img">
                    <img src="<?php echo URLROOT ?>/public/assets/images/slider/slider2.png" alt="slider image" />
                  </div>
                  <!--/.welcome-hero-txt-->
                </div>
                <!--/.single-welcome-hero-->
          ...
          <div class="welcome-hero-content">
            <div class="row">
              ...
              <div class="col-sm-5">
                <div class="single-welcome-hero">
                  <div class="welcome-hero-img">
                    <img src="<?php echo URLROOT ?>/public/assets/images/slider/slider3.png" alt="slider image" />
                  </div>
                  <!--/.welcome-hero-txt-->
                </div>
                <!--/.single-welcome-hero-->
...
<section id="clients" class="clients">
  <div class="container">
    <div class="owl-carousel owl-theme" id="client" style="display: flex; justify-content: space-between;">
      <div class="item">
        <a href="#">
          <img src="<?php echo URLROOT ?>/public/assets/images/clients/c1.png" alt="furn-image" />
        </a>
      </div>
      <!--/.item-->
      <div class="item">
        <a href="#">
          <img src="<?php echo URLROOT ?>/public/assets/images/clients/c2.png" alt="furn-image" />
        </a>
      </div>
      <!--/.item-->
      <div class="item">
        <a href="#">
          <img src="<?php echo URLROOT ?>/public/assets/images/clients/c3.png" alt="furn-image" />
        </a>
      </div>
      <!--/.item-->
      <div class="item">
        <a href="#">
          <img src="<?php echo URLROOT ?>/public/assets/images/clients/c4.png" alt="furn-image" />
        </a>
      </div>
      <!--/.item-->
      <div class="item">
        <a href="#">
          <img src="<?php echo URLROOT ?>/public/assets/images/clients/c5.png" alt="furn-image" />
        </a>
      </div>
      <!--/.item-->
    </div>
